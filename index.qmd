...
# Todo
- 他からリンクで引っ張ってきている個所は、引用をかく
- Title Slideは個別で画像を入れる
...
# QuartoとR Markdown{background="#ffffffe8" background-image="fig/rmdqmd.png" background-size="600px" background-position="bottom right" background-repeat="no-repeat"}

## 概要
- Pandocを基盤にした、研究・技術文書作成のための出版システム
...
- RStudioと同様、今後も生き残るらしいのでご安心を
    ...
    - R Markdownに満足しているのであれば、急いでQuartoに変える必要もない
...
- R Markdown -> 上記の方法もしくは［Preview］に［Render Document With R Markdown］

## その他

- [公式のチートシートもある](https://rstudio.github.io/cheatsheets/html/quarto.html)
...
# おしまい {background="#9ac7ffff" text="white"}
